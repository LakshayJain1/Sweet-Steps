...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/4 left-10 w-24 h-24 rounded-full bg-primary/10 blur-3xl animate-float" />
      <div className="absolute bottom-1/4 right-20 w-32 h-32 rounded-full bg-secondary/10 blur-3xl animate-float" style={{ animationDelay: "1s" }} />

      ...
      <div className="container mx-auto max-w-[1200px] px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="scroll-reveal" data-delay="4">
          ...
          <div className="relative hidden lg:block scroll-reveal" data-delay="2" data-from="scale">
            ...
            <div className="absolute -bottom-5 -left-6 glass-panel px-5 py-3 flex items-center gap-3 border-neutral-200/40 scroll-reveal" data-delay="4">
